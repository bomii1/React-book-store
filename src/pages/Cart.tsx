...
import { OrderSheet } from '../models/order.models';
import { useNavigate } from 'react-router';

const Cart = () => {

  const { carts, deleteCartItem, isEmpty } = useCart(); // 장바구니 데이처와 관련된 로직 제공
  const { showAlert, showConfirm } = useAlert();
  console.log(carts);
  
  // 라우트 사이에 데이터 전달해줄 수 있는 네비게이트
